...
export const metadata: Metadata = {
  ...
  title: {
    default: "DigiSprint — AI Marketing Assistant for Small Businesses",
    template: "%s | DigiSprint",
  },
  description:
    "Create daily posts, festival campaigns and practical marketing content with DigiSprint, the AI marketing assistant built for Indian small businesses.",
  keywords: ["AI marketing assistant", "small business marketing", "social media posts", "festival marketing", "Indian small business"],
  alternates: { canonical: "/" },
  openGraph: {
    title: "DigiSprint — AI Marketing Assistant for Small Businesses",
    description: "Daily posts, festival campaigns and practical AI marketing tools for Indian small businesses.",
    type: "website",
    url: "/",
    siteName: "DigiSprint",
  },
  twitter: {
    ...
    title: "DigiSprint — AI Marketing Assistant for Small Businesses",
    description: "Make everyday marketing simpler with DigiSprint, built for Indian small businesses.",
  },
