...
function SubmitButton(){const { pending }=useFormStatus();return <button className="strategy-primary" disabled={pending} type="submit">{pending ? "Building your foundation..." : "Generate Foundation"}</button>}
